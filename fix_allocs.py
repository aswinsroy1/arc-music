...
fun WavySlider(
    ...
    Box(
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            // Draw thumb with translation to avoid brush reallocation
            androidx.compose.ui.graphics.drawscope.translate(left = activeWidth, top = peakY) {
                // Draw thumb shadow
                androidx.compose.ui.graphics.drawscope.translate(top = 4.dp.toPx()) {
                    androidx.compose.ui.graphics.drawscope.scale(thumbRadius * 2f / size.minDimension) {
                        drawCircle(brush = shadowBrush)
                    }
                }
